<?php
// echo 'this is homepage from view <br>';
// echo 'category from homemodel <br>';
// foreach ($data as $key) {
//     echo $key['catOne'] . '<br>';
//     echo $key['catTwo'] . '<br>';
                        ...
                        <div class="grids_in">
                            <div class="content">
                                <div class="img-right-pro">
                                    <a href="sanpham.php">
                                        <img class="lazy img-pro content-image"
                                            src="<?= BASE_URL ?>public/img/iphone.png" data-original="image/iphone.png"
                                            alt="Máy in Canon MF229DW" />
                                    </a>
                                ...
                                <div class="name-pro-right">
                                    <a href="<?= BASE_URL ?>categoryproduct/detail">
                                        <h3>Iphone X 64GB</h3>
                                    </a>
                                </div>
                                <div class="add_card">
                        ...
                        <div class="grids_in">
                            <div class="content">
                                <div class="img-right-pro">
                                    ...
                                    <a href="sanpham.php">
                                        <img class="lazy img-pro content-image" src="<?= BASE_URL ?>public/img/mac.jpg"
                ...
                <div class="girds_all list_all_other_page ">
                    <div class="grids">
                        <div class="grids_in">
                            <div class="img-right-pro">
                                <a href="sanpham.php">
                                    <img class="lazy img-pro" src="<?= BASE_URL ?>public/img/phukien.jpg"
